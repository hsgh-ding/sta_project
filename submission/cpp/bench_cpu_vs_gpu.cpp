...
int main() {
    ...
    heterosta3d_read_sdc(sta, "constraints/gcd_complete.sdc", "ss_ff_cpu");
    heterosta3d_read_sdc(sta, "constraints/gcd_complete.sdc", "ss_ff_gpu");

    size_t num_pins = 1800, num_nets = 3300;
    ...
    // ═══════════════════════════════════════════════════
    FILE *fp = std::fopen("bench_result.txt", "w");
